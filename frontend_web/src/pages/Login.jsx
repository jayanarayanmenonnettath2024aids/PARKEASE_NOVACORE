...
export default function Login() {
    ...
    return (
        <div className={`flex flex-col md:flex-row justify-center items-center min-h-screen transition-colors duration-700 px-4 relative overflow-hidden ${isLampOn ? 'bg-[#1c1f24]' : 'bg-[#0f172a]'}`}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-1.5">
                        <div className="flex justify-between items-center ml-4">
                            ...
                            <a href="#" className="text-[10px] font-black uppercase tracking-widest text-brand hover:text-white transition-colors">Recover?</a>
                        </div>
                        <div className="relative group">
                            <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 group-focus-within:text-brand transition-colors">
